...

    {
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href:
              `https://github.com/loft-sh/vcluster-docs/new/main/staging?filename=your-doc-name.mdx&value=${
                encodeURIComponent(newDocTemplate)
              }`,
          ...
          {
            href: "https://devpod.sh/open#https://github.com/loft-sh/vcluster-docs@doc-478/improve-contribution",
            html: '<img alt="Open in DevPod" src="https://devpod.sh/assets/open-in-devpod.svg" style="height:36px" title="Click to open this repository in DevPod. You can contribute to the docs without any local setup!" />',
            position: "right",
            target: "_blank",
            className: "open-in-devpod-button",
          },
        ],
      },
      algolia: {
